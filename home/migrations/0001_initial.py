# -*- coding: utf-8 -*-
# Generated by Django 1.9.5 on 2018-01-21 15:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avator', models.ImageField(blank=True, default='avator/default.png', max_length=200, null=True, upload_to='avator/%Y/%m', verbose_name='\u7528\u6237\u5934\u50cf')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.URLField(blank=True, max_length=100, null=True, verbose_name='\u4e2a\u4eba\u7f51\u9875\u5730\u5740')),
                ('date_publish', models.DateTimeField(auto_now_add=True, verbose_name='\u53d1\u5e03\u65f6\u95f4')),
                ('article', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='home.Article', verbose_name='\u6587\u7ae0')),
                ('pid', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='home.Comment', verbose_name='\u7236\u7ea7\u8bc4\u8bba')),
        ...
        migrations.AddField(
            model_name='article',
            name='category',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='home.Category', verbose_name='\u5206\u7c7b'),
        ),
        migrations.AddField(
            model_name='article',
            name='tag',
